        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex-1">
              ...
              <p className="text-lg leading-relaxed" style={{ color: "rgba(255,255,255,0.55)", maxWidth: "560px" }}>
                C&apos;est dans les salles de Futurcraft Institut que mon parcours en ingénierie logicielle a pris forme. Un centre de formation innovant basé à Cotonou, qui forme la prochaine génération de développeurs, designers et entrepreneurs du numérique en Afrique.
              </p>
            ...
            <div
              className="flex h-32 w-32 shrink-0 items-center justify-center rounded-2xl self-start lg:self-center"
