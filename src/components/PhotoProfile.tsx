          ...
          >
            <div className="relative">
              <div
                ...
                style={{ background: "radial-gradient(ellipse, #00FF6630, transparent 70%)" }}
              />
              <div
              ...
              >
                ...
                <p className="text-sm font-bold" style={{ color: "#00FF66" }}>pour des projets</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3 text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
                <MapPinIcon className="h-4 w-4 shrink-0" style={{ color: "#00FF66" }} />
                Cotonou, Bénin — disponible en remote
              </div>
              <div className="flex items-center gap-3 text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>
                <EnvelopeIcon className="h-4 w-4 shrink-0" style={{ color: "#00FF66" }} />
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                style={{ background: "#00FF66", fontFamily: "var(--font-space-grotesk)" }}
              >
                Me contacter →
              </a>
              <a
