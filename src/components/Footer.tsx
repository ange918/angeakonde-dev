    ...
    <footer className="border-t px-5 py-10" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div className="flex items-center gap-6 text-xs" style={{ color: "rgba(255,255,255,0.35)" }}>
          ...
          <a href="#progiciel" className="hover:text-white transition-colors">Progiciels</a>
          <a href="#contact" className="hover:text-white transition-colors">Contact</a>
          <a href="https://github.com/ange918" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
            GitHub
          </a>
        </div>
